...
WAGE =  8.85#float(input("what is your hourly\n"))

RWW = 40#int(input("What is the regular amount of hours you work \n"))

OVTpayrate = 1.5#float(input("What is your overtime rate?\n"))

week = 3#int(input("How many weeks are you working?\n"))
